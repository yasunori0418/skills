...
| 配布・パッケージング | Claude Code plugin | per-category `skills/<category>/.claude-plugin/plugin.json` + `.claude-plugin/marketplace.json`（7 プラグイン） |
...
1 マーケットプレイス（`.claude-plugin/marketplace.json`）に 7 プラグインを列挙し、
